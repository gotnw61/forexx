...
def main():
    ...
    try:
        ...
        st.error(f"Bot başlatılırken bir hata oluştu: {str(e)}")
        import traceback
...
def initialize_bot():
    ...
    try:
        ...
        print("ForexTradingBot modülü içe aktarılıyor...")
        from main import ForexTradingBot
        
        print("Bot örneği oluşturuluyor...")
        ...
        # Mock bot oluştur (test için)
        from collections import namedtuple
        MockBot = namedtuple('MockBot', ['settings', 'broker', 'data_manager', 'analysis_engine', 
                                         'ai_predictor', 'signal_generator', 'risk_manager', 
                                         'telegram_bot', 'start', 'stop'])
...
if __name__ == "__main__":
    ...
    bot.start()
    print("Bot başlatıldı, UI gösteriliyor...")
